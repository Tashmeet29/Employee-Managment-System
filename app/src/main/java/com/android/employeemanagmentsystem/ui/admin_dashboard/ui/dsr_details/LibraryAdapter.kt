...
private const val TAG = "LibraryProducts"

class LibraryAdapter(
    private val products: List<ProductDistr>,
    private val listener: LibraryAdapter.ProductDistrClickListener
): RecyclerView.Adapter<LibraryAdapter.ProductDistrViewModel>() {
