...
private const val TAG = "OfficeProducts"

class OfficeAdapter(
    private val products: List<ProductDistr>,
    private val listener: OfficeAdapter.ProductDistrClickListener
): RecyclerView.Adapter<OfficeAdapter.ProductDistrViewModel>() {
